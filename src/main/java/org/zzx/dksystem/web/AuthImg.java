...
public class AuthImg extends HttpServlet
{
    ...
    private final Font mFont =
            new Font("Arial Black", Font.PLAIN, 30);
    // 定义图形验证码的大小
    private final int IMG_WIDTH = 180;
            ...
            throws ServletException, IOException
    {
        ...
        for (var i = 0; i < 30; i++)
        {
            var x = random.nextInt(IMG_WIDTH - 1);
            var y = random.nextInt(IMG_HEIGTH - 1);
            var xl = random.nextInt(12) + 1;
            var yl = random.nextInt(24) + 1;
