drop database if exists Dksystem;

create database Dksystem;
...
insert into employee_inf (emp_type , emp_name , emp_pass , emp_salary , mgr_id , dept_name)
	values (2, 'lubenwei', '123456' , 8000 , null , 'DB部');
insert into employee_inf (emp_type , emp_name , emp_pass , emp_salary , mgr_id , dept_name)
	values (2, 'lubenwei2', '123456' , 9200 , null , 'Server部');
# 员工
insert into employee_inf (emp_type , emp_name , emp_pass , emp_salary , mgr_id)
	values (1 , 'huanjintao', '123456' , 5000 , 1);
insert into employee_inf (emp_type , emp_name , emp_pass , emp_salary , mgr_id)
	values (1 , '黄锦韬', '123456' , 5200 , 1);
insert into employee_inf (emp_type , emp_name , emp_pass , emp_salary , mgr_id)
	values (1 , 'taotao', '123456' , 4800 , 2);
insert into employee_inf (emp_type , emp_name , emp_pass , emp_salary , mgr_id)
	values (1 , 'qingyuanji', '123456' , 5560 , 2);
